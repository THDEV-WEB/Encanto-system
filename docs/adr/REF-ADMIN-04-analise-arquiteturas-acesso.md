...
| **Achado colateral (higiene, não é arquitetura de acesso, mas relevante para este REF):** | `AdminLogin.jsx:8` pré-preenche o campo e-mail com um endereço real (`useState('as992203620@gmail.com')`) — expõe a identidade do administrador a qualquer um que abra o DevTools, independente de qual arquitetura for escolhida |
