...
/* REF-BOOT-01 Onda 2 — data/hora de eventos do PEDIDO no fuso da LOJA (America/Sao_Paulo).
   ...
   2019). REF-DATETIME-01: unico formatador de data/hora do app (fmtDate, que nao fixava fuso, foi
   removido — usava o fuso do DISPOSITIVO em vez do da loja, "funcionando por coincidencia" so pra quem
   estava em America/Sao_Paulo). Todo consumidor (comanda, pedidos, admin, Minha Conta) usa este. */
