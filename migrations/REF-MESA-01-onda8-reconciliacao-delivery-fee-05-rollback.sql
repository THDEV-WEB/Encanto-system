-- ============================================================================
-- REF-MESA-01 · Onda 8 — ROLLBACK
-- Restaura create_order()/admin_orders_search() para o estado EXATO em que a
-- REF-DELIVERY-FEE-05-onda2-adicional-pagamento.sql os deixou (isto e', o estado
-- imediatamente ANTERIOR a esta reconciliacao) -- byte-a-byte, confirmado contra
-- a definicao real ao vivo em producao antes de escrever a migration de
-- reconciliacao. Nao tenta "desfazer so a parte de Mesa" preservando o resto --
-- rollback restaura o estado anterior real, ponto (mesmo padrao ja usado pelos
-- outros rollbacks desta REF).
-- ============================================================================
