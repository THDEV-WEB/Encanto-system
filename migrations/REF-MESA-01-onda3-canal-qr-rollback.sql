-- ============================================================================
-- REF-MESA-01 · Onda 3 — ROLLBACK
-- Restaura create_order() para a forma da Onda 1 (sem a checagem de mesa_canal_qr
-- para origem_pedido='qr_mesa') -- byte-a-byte igual a
-- migrations/REF-MESA-01-onda1-fundacao.sql. Nao mexe em colunas/constraints
-- (ja existiam desde a Onda 1) nem em get_mesa_config/set_mesa_config.
-- ============================================================================
