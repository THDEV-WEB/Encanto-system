-- Rollback de REF-PROD-GOLIVE-01-fix-tenant-validation.sql -- restaura resolve_store_from_origin(),
-- create_order() e link_customer_to_auth() para as versoes byte-identicas anteriores (REF-STORE-
-- ONBOARD-01 Onda 2 / REF-SEC-02 Onda 1 / REF-AUTH-TENANT-01 Onda 6). Reabre o MT-01/MT-02 --
-- so usar se a correcao nova causar regressao real e inesperada em producao.
