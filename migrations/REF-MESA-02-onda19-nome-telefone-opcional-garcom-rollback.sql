-- ============================================================================
-- REF-MESA-02 · Onda 19 — ROLLBACK: restaura nome/telefone obrigatorios em TODOS os canais
-- (volta ao comportamento anterior a esta onda -- corpo identico ao que estava em producao antes).
-- ============================================================================
