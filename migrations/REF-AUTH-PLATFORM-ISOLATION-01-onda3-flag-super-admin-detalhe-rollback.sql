-- Rollback de REF-AUTH-PLATFORM-ISOLATION-01-onda3-flag-super-admin-detalhe.sql
-- Restaura platform_tenant_detail ao estado anterior (REF-SAAS-02 · Onda 1), sem o campo is_super_admin
-- por administrador.
