-- Rollback de REF-STORE-ONBOARD-02-onda1-checklist-lancamento.sql
-- Restaura platform_tenant_detail ao estado anterior (REF-AUTH-PLATFORM-ISOLATION-01 · Onda 3), sem os
-- campos tem_catalogo/tem_coordenadas/tem_eta_customizado/tem_modo_customizado em 'config'.
