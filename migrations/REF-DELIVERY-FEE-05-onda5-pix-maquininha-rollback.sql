-- Rollback REF-DELIVERY-FEE-05 · Onda 5 — restaura _resolve_delivery_fee para a versão da Onda 4
-- (PIX físico volta a NÃO acionar maquininha_fee nem adicional_pagamento_fee).
BEGIN;
