-- ============================================================================
-- REF-MESA-01/02 · Onda 5 (QR protegido) — ROLLBACK
-- Restaura create_order()/admin_listar_mesas() ao estado da Onda 4 (byte-a-
-- byte) e remove qr_token/resolver_mesa_por_token.
-- ============================================================================
...
DROP FUNCTION IF EXISTS public.resolver_mesa_por_token(uuid);
...
ALTER TABLE public.mesas DROP CONSTRAINT IF EXISTS mesas_qr_token_uniq;
ALTER TABLE public.mesas DROP COLUMN IF EXISTS qr_token;
