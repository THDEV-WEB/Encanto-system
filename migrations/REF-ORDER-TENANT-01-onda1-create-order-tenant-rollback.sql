-- Rollback da Onda 1 de REF-ORDER-TENANT-01.
-- Restaura create_order() EXATAMENTE como estava antes (p_store_id confiado direto, sem validacao
-- de tenant nem resolucao por Origin) e remove resolve_store_from_origin().
...
DROP FUNCTION IF EXISTS public.resolve_store_from_origin();
