-- ============================================================================
-- REF-MESA-01 · Onda 4 — ROLLBACK
-- Restaura create_order() para a forma da Onda 3 (byte-a-byte igual a
-- migrations/REF-MESA-01-onda3-canal-qr.sql) -- sem a checagem de
-- mesa_canal_admin/is_admin_of para origem_pedido='admin_garcom'. Nao mexe em
-- colunas/constraints (ja existiam desde a Onda 1) nem em get_mesa_config/
-- set_mesa_config.
-- ============================================================================
