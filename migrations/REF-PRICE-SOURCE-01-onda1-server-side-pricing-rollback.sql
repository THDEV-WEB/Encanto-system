-- Rollback REF-PRICE-SOURCE-01 · Onda 1 -- restaura create_order() byte-identico a versao anterior
-- (REF-PROD-GOLIVE-01-fix-name-overwrite.sql, "prod-golive-01b", confirmada via pg_get_functiondef()
-- contra producao antes desta migration) e remove a funcao auxiliar _resolve_item_pricing.
...
DROP FUNCTION IF EXISTS public._resolve_item_pricing(uuid,uuid,text,jsonb);
