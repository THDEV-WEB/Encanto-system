-- Rollback REF-PAYMENT-SEC-02 · Onda 1 — restaura create_order(), _processar_webhook_payment_intent()
-- e _registrar_criacao_pagamento() para o estado exato pos-Onda 4 (pre-Onda 1), sem a concessao
-- deferida de selo de fidelidade.
BEGIN;
