-- REF-SAAS-01 · Onda 7.1 — ROLLBACK. Restaura os defaults de identidade/contato de get_company_info()
-- para os valores da Encanto (estado anterior a esta migration).
