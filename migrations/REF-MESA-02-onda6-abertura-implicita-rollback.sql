-- ============================================================================
-- REF-MESA-02 · Onda 6 — ROLLBACK
-- Restaura create_order()/get_mesa_config()/set_mesa_config() ao estado da
-- Onda 5 (byte-a-byte) e remove _get_or_open_mesa_session.
-- ============================================================================
...
DROP FUNCTION IF EXISTS public._get_or_open_mesa_session(uuid, text, text, uuid);
...
DROP FUNCTION IF EXISTS public.set_mesa_config(boolean, boolean, boolean, boolean, uuid);
