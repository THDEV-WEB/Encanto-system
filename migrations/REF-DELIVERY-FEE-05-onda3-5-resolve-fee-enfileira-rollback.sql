-- ════════════════════════════════════════════════════════════════════════════════════════════════
-- Rollback de REF-DELIVERY-FEE-05-onda3-5-resolve-fee-enfileira.sql — reaplica exatamente a versao
-- da Onda 3.3 (le o cache, mas NAO enfileira novos calculos via _enfileirar_calculo_rota).
--
