-- ROLLBACK REF-DELIVERY-FEE-04 · Onda 2.
-- Restaura create_order() para a versao exata da Onda 1 (byte-identica ao arquivo
-- migrations/REF-DELIVERY-FEE-04-onda1-delivery-fee-autoritativo.sql, commit 4fdc1ad) -- remove a
-- checagem de divergencia, volta a persistir silenciosamente o valor autoritativo.
