-- Rollback REF-DELIVERY-FEE-05 Onda 4 -- restaura _resolve_delivery_fee() ao texto EXATO capturado
-- ao vivo em producao antes desta migration (introspeccao via pg_get_functiondef, 2026-09-09) --
-- volta a somar maquininha_fee + adicional_pagamento_fee sem exclusividade mutua.
BEGIN;
