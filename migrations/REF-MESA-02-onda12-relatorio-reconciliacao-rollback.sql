-- ============================================================================
-- REF-MESA-02 · Onda 12 (relatorio/reconciliacao) — ROLLBACK
-- Restaura admin_reports_summary() ao estado da Onda 6 de MESA-01 (byte-a-
-- byte, por_pagamento volta a agrupar so' por orders.payment_method).
-- ============================================================================
