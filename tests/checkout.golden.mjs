...
const GOLDEN_PAYLOAD = {
  ...
  p_order: { total: 56, status: 'recebido', payment_method: 'pix', address: 'Rua A, 100, Centro', observacoes: 'sem cebola', endereco_id: null, delivery_fee: 0, maquininha_fee: 0, adicional_pagamento_fee: 0, retirada: false },
  p_items: [
